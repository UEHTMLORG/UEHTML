...
@property (nonatomic, strong,readwrite) NSString *vertificationCode;//内容
@end
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.selectedColor = [UIColor colorWithHexString:UIToneTextColorStr];
        self.deselectColor = [UIColor colorWithHexString:UIToneTextColorStr];   //默认边框颜色
...
-(void)getVertificationCode{ //获取方法
