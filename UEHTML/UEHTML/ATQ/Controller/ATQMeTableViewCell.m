...
@end
NSString *const MeOperationButtonClickedNotification = @"MeOperationButtonClickedNotification";
@implementation ATQMeTableViewCell
...
//    self.nameLabel = nameLabel;
    ...
    ATQOperationView *opView = [[ATQOperationView alloc] init];
    ...
    [deleteBtn setTitleColor:[UIColor colorWithHexString:UIDeepTextColorStr] forState:UIControlStateNormal];
    [deleteBtn addTarget:self action:@selector(delClick) forControlEvents:UIControlEventTouchUpInside];
...
//      make.left.mas_equalTo(timeLab.mas_right).offset(-10);
    ...
    [deleteBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(chakanLab.mas_right).offset(5);
    }];
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:MeOperationButtonClickedNotification object:self.operationBtn];
}
